...
function add(a, b) { // 함수 정의 시 소괄호 안의 키워드는 매개변수(파라미터)
  // let a = 3;
  // let b = 4;
  console.log(a + b);
}
...
log(); // 아규먼트가 없는 경우 (파라미터의 개수보다 적음) - undefined
log('안녕'); // 한 개의 아규먼트 (파라미터의 개수와 동일) - '안녕'
log('hello', 'hi'); // 두 개의 아큐먼트 (파라미터의 개수보다 많음) - 지정된 수의 파라미터 이상의 아규먼트는 읽히지 않음, 즉 hello 만 나옴
