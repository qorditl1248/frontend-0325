        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    response = _a.sent();
                    if (!response.ok) {
                        throw new Error("네트워크 요청이 정상적이지않습니다.");
                    }
            ...
            userList.addEventListener("click", function (event) {
                ...
                if (userCard) {
                    ...
                    if (user) {
                        ...
                        var closeModla = document.getElementsByClassName("close")[0];
                        if (modal_1 && closeModla) {
                            closeModla.addEventListener("click", function () {
