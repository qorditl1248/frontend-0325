...
document.getElementById('fetchUserData').addEventListener('click', function () { return __awaiter(_this, void 0, void 0, function () {
...
var userIdElement = document.getElementById('input');
