...
//? 식별자 종류별 명명 규칙
// 클래스명: 항상 '대문자'로 시작
// 변수, 인스턴스, 함수, 메소드 명: 항상 '소문자'로 시작
// 여러 단어로 이루어진 식별자는 각 단어의 첫 글자를 대문자로 시작 -> userName
...
// - prompt('메시지');
// - prompt('메시지', '기본값');
// 위의 기본값은 >> input의 placeholder와 같은 기능 (무엇을 입력할지 설명해주는 쓰면 없어짐)
