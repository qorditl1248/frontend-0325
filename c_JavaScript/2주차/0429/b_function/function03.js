...
function defaultParams(param1='defaultBalue1', param2=2) {};
...
greet(); // 안녕하세요 이승아님
// : 전달되는 인자가 없는 경우 - 파라미터에 초기화되지 않는 경우 기본 매개변수가 사용 

greet('이도경'); // 안녕하세요 이도겸님
// : 전달되는 인자가 있는 경우 - 해당 인지값이 사용
...
function exampleFunction(param1, param2, ...args){ // arguments 축약어! 잘 씀!
  //let param1;
  //let param2;
  //let args = [];
