...
// : 첫 번째 호출에서는 초기값(initialValue)이 지정
// : 각 호출에서 축적되는 값
...
console.log(combinedcar); // audi, bmw, hyundai, volvo (배열이 아닌 문자열로 반환)
...
// numberArray.sort(); // sort 함수 내부에 콜백 함수가 생략 >> '유니코드' 값 순서대로 정렬 (오름차순 정렬)
