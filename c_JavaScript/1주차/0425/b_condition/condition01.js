...
let number = 10;
// : number 변수가 0 보다 크다면 해당 숫자가 양수임을 출력 
...
//& if-else문의 코드 축약
// 실행 될 코드 블럭이 한 줄일 경우에만 코드 축약이 가능

console.log(`===if-eles문 코드 축약===`);
number = 10;
...
console.log(booleanData); // 빈 문자열이 아니기 때문에 true 
