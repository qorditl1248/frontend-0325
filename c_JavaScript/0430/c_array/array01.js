...
// Tip) 콜론(:)이나 콤마(,)의 경우 앞선 문자와는 붙여쓰기, 뒤의 문자와는 띄어쓰기를 권장 
...
// 기존의 배열을 늘리면 새로운 요소는 undefined로 초기화
sports.length = 4; // 길이 늘림
console.log(sports); //  <2 empty items>  - undefined의 값이 2개 

sports[3] = '배구';
console.log(sports); // [ '축구', 'baseball', <1 empty item>, '배구' ] 

//! 1. 배열 탐색 및 정보 확인
//& 반복 학습이 중요! 다 중요함 꼭 외워두기 ~~
