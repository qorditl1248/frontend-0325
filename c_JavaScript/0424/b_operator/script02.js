...
console.log(`===단락평가===`);
// 1) AND 연산자 (&&)
// : 앞선 피연산자가 false로 평가 될 경우, 그 뒤의 피연산자는 평가 없이 바로 false를 반환

true && false && console.log(`and 연산자의 단락평가`); // 출력안됨 
...
true || console.log(`or 연산자의 단락평가`); // 출력 안됨
...
// 비교연산자가 대입연산자보다 연산의 우선순위를 가짐 
let beverage = age >= 20 ? 'Beer' : 'Juice';
console.log(beverage);

console.log(age >= 20 ? 'Beer' : 'Juice' );

let isMember = true; // boolean 타입의 변수 (회원의 여부를 사용)

console.log(discount = isMember ? '10%' : '5%');