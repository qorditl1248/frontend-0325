...
function text(objcet) {
  if (!objcet || objcet.a === undefined || objcet.b === undefined ) {
    throw new Error('함수를 호출할 때 object 인자와 그의 a및 b 속성을 지정해야합니다.');
  }
  console.log(objcet.a + objcet.b);
}
