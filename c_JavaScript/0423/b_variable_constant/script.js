...
// 올해 연도를 나타내는 변수에는 2024 값 '할당' (초기화)
...
var a = 5; // 변수 선언과 동시에 초기화

//? let과 const의 호이스팅
// console.log(b); - Error
// : 초기화 되기전에 b에 접근 할 수 없음 (호이스팅은 되었지만, TDZ가 변수의 선언부에 접근할 수 없도록 방지)
let b = 10;
