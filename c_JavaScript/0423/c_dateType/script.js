...
let multiLinel1 = "안녕하세요"; 
// 일반 따옴표의 경우 여러 줄 문자 작성이 불가
let multiLinel2 = `백틱을 사용한 템플릿 문자열은
여러 줄로 작성 가능합니다
세 번째 줄 작성 중 입니다`;
console.log(multiLinel2);

//? 논리형 (Boolean)
// : 참(true) | 거짓(false) 값만을 가지는 자료형
// : 조건문이나 반복문에서 조건의 참과 거짓을 판단하는데 사용
...
let navValue = NaN;
console.log(navValue); // NaN (데이터 타입이 아니라 값!!)
...
console.log(stringToBoolean2); // flase
console.log(numberToBoolean2); // flase
